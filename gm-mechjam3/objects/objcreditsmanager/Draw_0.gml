...
if(isActive)
{
	...
	draw_text(room_width/2, 20, "TEAM DELINQUENT INSTINCT");
	
	draw_set_halign(fa_left);
	
	draw_set_color(c_yellow);
	draw_text(100, 50, "Steven Rynders");
	...
	draw_set_color(c_white);
	draw_text(380, 70, "@LazyAhab");
	draw_text(380, 90, "Design, Programming,");
	draw_text(380, 110, "Music, Writing, Icons");
	...
	draw_set_color(c_yellow);
	draw_text(380, 150, "Fey Harkness");
	draw_set_color(c_white);
